...
import FooterSocialIcon from "../components/FooterSocialIcon.tsx";
  ...
  return (
    <>
      ...
      <div className="bg-dark py-4 text-light">
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-between px-3 sm:flex-row">
